...
import com.example.member.common.config.interceptor.AuthRequestFilter;
import com.example.member.common.config.resolver.UserEntityResolver;
...
@Configuration
@ComponentScan(
        basePackages = {"org.example.core", "com.example.member", "org.example.log"},
        excludeFilters = @ComponentScan.Filter(
                type = FilterType.REGEX,
                pattern = "com.example.member.common.config.security.*" // 제외할 패키지 패턴
        )
)
@EnableWebMvc
...
public class MvcConfig implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        registry.addInterceptor(authRequestFilter()).addPathPatterns("/**");
    }
