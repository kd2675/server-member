package com.example.member.service.auth.database;
...
@EnableJpaRepositories(
        basePackages = {"org.example.database.auth.database.rep.jpa", "com.example.member.service.auth.database.rep.jpa"},
